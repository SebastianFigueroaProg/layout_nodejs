...
//Editar Call T Cordoba
exports.editTcor = (req, res)=>{
    let fecha = new Date();
    const id          = req.body.id;
    const boxId       = req.body.boxId
    const box         = req.body.box;
    ...
    conexion.query('UPDATE agentes_callt SET ? WHERE boxId = ?', [{estadoPc:estadoPc, obleaPC:obleaPc,DNI:dni,nombre:nombre,ingreso:ingreso,egreso:egreso,lider:lider,
    jefe:jefe, servicio:servicio,modalidadTT:modalidadTT,editor:editor,fechaEdicion},boxId],(error, results)=>{
